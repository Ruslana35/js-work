...
let towns = [];
loadingFailedBlock.classList.hidden = true;
filterBlock.classList.hidden = true;

async function tryToLoad() {
  try {
    towns = await loadTowns();
    loadingBlock.classList.hidden = true;
    loadingFailedBlock.classList.hidden = true;
    filterBlock.classList.hidden = false;
  } catch (e) {
    loadingBlock.classList.hidden = true;
    loadingFailedBlock.classList.hidden = false;
  }
}
